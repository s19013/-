...
class GameWithManActivity : AppCompatActivity() {
    ...
    private val B1 = Mas("B1",1,0)
    private val C1 = Mas("C1",2,0)
    private val D1 = Mas("D1",3,0)
    private val A2 = Mas("A2",0,1)
    private val B2 = Mas("B2",1,1)
    private val C2 = Mas("C2",2,1)
    private val D2 = Mas("D2",3,1)
    private val A3 = Mas("A3",0,2)
    private val B3 = Mas("B3",1,2)
    private val C3 = Mas("C3",2,2)
    private val D3 = Mas("D3",3,2)
    private val A4 = Mas("A4",0,3)
    private val B4 = Mas("B4",1,3)
    private val C4 = Mas("C4",2,3)
