...
class GameWithManActivity : AppCompatActivity() {
    ...
    //マス宣言
    private val A1 = Mas("A1",0,0)
    private val B1 = Mas("B1",0,1)
    private val C1 = Mas("C1",0,2)
    private val D1 = Mas("D1",0,3)
    private val A2 = Mas("A2",1,0)
    private val B2 = Mas("B2",1,1)
    private val C2 = Mas("C2",1,2)
    private val D2 = Mas("D2",1,3)
    private val A3 = Mas("A3",2,0)
    private val B3 = Mas("B3",2,1)
    private val C3 = Mas("C3",2,2)
    private val D3 = Mas("D3",2,3)
    private val A4 = Mas("A4",3,0)
    private val B4 = Mas("B4",3,1)
    private val C4 = Mas("C4",3,2)
    private val D4 = Mas("D4",3,3)
    ////文字列
    //手持ち
